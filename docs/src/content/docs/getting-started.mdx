...
A [Starlight](https://starlight.astro.build) theme heavily inspired by the timeless design of the [legacy Astro documentation](https://web.archive.org/web/20231203051122/https://docs.astro.build/en/getting-started/).
